...
if __name__ == '__main__':
    ...
    parser.add_argument("--src_dir",type=str,default='/home/shahzaa/Downloads/Diving48_rgb/rgb/')
    parser.add_argument("--out_dir", type=str,default='/media/sdb_access/Data_for_Action_CLIP/Diving_48/')
    ...
    # class_ind_dict={}
    # with open('/media/shahzaa/b945bf86-6e1a-4a4a-8420-ee7e35f529d1/HMDB_51/hmdb51_labels.csv', mode ='r')as file:
    ...
    with open('/home/shahzaa/Downloads/Diving48_train.json', 'r') as file:
        train_data = json.load(file)
    for video_detail in train_data:
        video_name = video_detail['vid_name']+'.mp4'
        video_path = os.path.abspath(os.path.join(src_path, video_name))
        class_ind = video_detail['label']
        type = 'train'
        vid_list.append([video_path, type, class_ind])
        
        
    with open('/home/shahzaa/Downloads/Diving48_test.json', 'r') as file:
        test_data = json.load(file)
    for video_detail in test_data:
        video_name = video_detail['vid_name']+'.mp4'
        video_path = os.path.abspath(os.path.join(src_path, video_name))
        class_ind = video_detail['label']
        type = 'test'
    ...
    # writing to file
    file1 = open('/media/sdb_access/Data_for_Action_CLIP/Txts/Diving_48/train.txt', 'w')
    file1.writelines(list(train_video_path))
    file1.close()

    file2 = open('/media/sdb_access/Data_for_Action_CLIP/Txts/Diving_48/test.txt', 'w')
