...
if __name__ == '__main__':
    ...
    parser.add_argument("--src_dir",type=str,default='/media/shahzaa/b945bf86-6e1a-4a4a-8420-ee7e35f529d1/HMDB_51/all_video/')
    parser.add_argument("--out_dir", type=str,default='/media/shahzaa/b945bf86-6e1a-4a4a-8420-ee7e35f529d1/Data_for_Action_CLIP/HMDB51/')
    ...
    vid_list = []
    video_list_txts = glob.glob('/media/shahzaa/b945bf86-6e1a-4a4a-8420-ee7e35f529d1/HMDB_51/test_train_splits/split_1/*')
    ...
    # writing to file
    file1 = open('/media/shahzaa/b945bf86-6e1a-4a4a-8420-ee7e35f529d1/HMDB_51/train.txt', 'w')
    file1.writelines(list(train_video_path))
    file1.close()

    file2 = open('/media/shahzaa/b945bf86-6e1a-4a4a-8420-ee7e35f529d1/HMDB_51/test.txt', 'w')
