...
if __name__ == '__main__':
    ...
    parser.add_argument("--src_dir",type=str,default='/media/sdb_access/UCF_101_dataset/UCF-101')
    parser.add_argument("--out_dir", type=str,default='/media/sda1_acces/Data_for_Action_CLIP/UCF_101_2')
    ...
    train_txt=['/media/sda1_acces/Data_for_Action_CLIP/ucfTrainTestlist/trainlist01.txt']
    ...
    test_txt=['/media/sda1_acces/Data_for_Action_CLIP/ucfTrainTestlist/testlist01.txt']
    ...
    label_index_file = '/media/sda1_acces/Data_for_Action_CLIP/ucfTrainTestlist/classInd.txt'
